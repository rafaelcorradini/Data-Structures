...
/* Função para adicionar uma aresta ao grafo através dos ponteiros dos vertices */
...
/* Função que devolve o vértice oposto */
...
// Extelecomunicações
void makeGraphConnectivity(graph* g, node* n);
